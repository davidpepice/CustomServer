...
class Client {
    constructor(server, socket) {
        ...
        this.ejectRequestedMacro = false;
    ...
    handshake_onCompleted(protocol, key) {
        this.handler = {
            ...
            25: this.msg_ejectMacro.bind(this),
    ...
    msg_ejectMacro(message) {
       // if (message.length !== 1) return;
         this.ejectRequestedMacro = true;
    }
    ...
    process() {
        ...
        if (this.ejectRequestedMacro) {
            this.socket.player.ejectMacro();
            this.ejectRequestedMacro = false;
        }
